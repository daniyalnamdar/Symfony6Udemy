...
class MicroPostRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(MicroPost $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(MicroPost $entity, bool $flush = true): void
    {
    ...
    public function findAllByAuthor(int | User $author): array
    {
        return $this->findAllQuery(
            withComments: true, withLikes: true, withAuthors: true, withProfiles: true
        )
